...
export const PrimaryButtonSmall = ({ disabled, onPress, iconStyle, iconSource, title, loading, color, showNextArrows = false }) => {
      ...
      <Ripple
        ...
        {(
          <View style={[{
            ...
            <Text style={disabled ? appStyles.text_14_secondaryFont_dark8 : appStyles.text_14_reg_secondaryFont}>{title}</Text>
